...
import { IgxListModule, IgcFormsModule, IgxChipsModule, IgxAvatarModule, IgxIconModule, IgxAccordionModule, IgxExpansionPanelModule } from '@infragistics/igniteui-angular';
